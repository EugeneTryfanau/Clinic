...
{
    /// <inheritdoc />
    public partial class FullDbStructure : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DoctorSpecializationEntity", x => new { x.DoctorId, x.SpecificationId });
                    table.ForeignKey(
                        name: "FK_DoctorSpecializationEntity_Doctors_DoctorId",
                        column: x => x.DoctorId,
                        principalTable: "Doctors",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DoctorSpecializationEntity_Specializations_SpecificationId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DoctorSpecializationEntity_SpecificationId",
